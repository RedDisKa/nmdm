...
export const getAccountTypesList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listLoaded<AccountType>(actionTypes.ACCOUNT_TYPES_LIST_LOADED, list))
    } catch (error) {
        dispatch(listFailure(actionTypes.ACCOUNT_TYPES_LIST_FAILURE, error.message))
    }
}
...
export const getMarketSizesList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listLoaded<MarketSize>(actionTypes.MARKET_SIZE_TYPES_LIST_LOADED, list))
    } catch (error) {
        dispatch(listFailure(actionTypes.MARKET_SIZE_TYPES_LIST_FAILURE, error.message))
    }
}
...
export const getCountriesList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listFailure(actionTypes.COUNTRIES_LIST_FAILURE, error.message))
    }
}
...
export const getIndustryVerticalList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listFailure(actionTypes.INDUSTRY_VERTICAL_LIST_FAILURE, error.message))
    }
}
...
export const getIndustrySegmentList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listFailure(actionTypes.INDUSTRY_SEGMENT_LIST_FAILURE, error.message))
    }
}
...
export const getStateProvincesList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listFailure(actionTypes.STATE_PROVINCES_LIST_FAILURE, error.message))
    }
}
...
export const getPhoneFaxTypesList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listFailure(actionTypes.PHONE_FAX_TYPES_LIST_FAILURE, error.message))
    }
}
...
export const getPhoneFaxRolesList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listFailure(actionTypes.PHONE_FAX_ROLES_LIST_FAILURE, error.message))
    }
}
...
export const getExternalIdentifierTypeList = () => async (dispatch: any) => {
    ...
    try {
        ...
        dispatch(listLoaded(actionTypes.EXTERNAL_IDENTIFIER_TYPES_LIST_LOADED, list))
    } catch (error) {
        dispatch(listFailure(actionTypes.EXTERNAL_IDENTIFIER_TYPES_LIST_FAILURE, error.message))
    }
}

const listRequest = <T>(action: any) => {
    return {
        type: action,
        payload: {
            list: null,
